 ...
 *           Hzkkk
 */
void SerialPort::RMserialWrite(float rect_x,float rect_y)
{
...
void SerialPort::getDataForCRC(float rect_x,float rect_y)
{
    g_CRC_buf[0] = 0x53;
    g_CRC_buf[1] = static_cast<unsigned int>(rect_x);
    g_CRC_buf[2] = static_cast<unsigned int>(rect_y);
}

void SerialPort::getDataForSend(float rect_x,float rect_y,uint8_t CRC)
{
    g_write_buf[0] = 0x53;
    g_write_buf[1] = static_cast<unsigned int>(rect_x);
    g_write_buf[2] = static_cast<unsigned int>(rect_y);
    g_write_buf[3] = CRC & 0xff;
    g_write_buf[4] = 0x45;
}
