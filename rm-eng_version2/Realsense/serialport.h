...
*/
/** Serious **/
#define WRITE_BUFF_LENGTH 5
/**
  @brief: 写入串口的Buff长度
  */

#define CRC_BUFF_LENGTH 3
/**
...
public:
  ...
  static void getDataForCRC(float rect_x,float rect_y);
  static void getDataForSend(float rect_x,float rect_y, uint8_t CRC);
};
